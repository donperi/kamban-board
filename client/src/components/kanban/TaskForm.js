...
const TaskForm = ({ initialValues = {}, onSubmit, onCancel, submitText = 'Submit', cancelText = 'Cancel' }) => {
      ...
      render={props => (
        <Form onSubmit={props.handleSubmit}>
          <Form.Group>
            ...
            <Field required className="form-control" name="title" placeholder="Awesome Task" />
          </Form.Group>

          <Form.Group>
            <Form.Label>Description</Form.Label>
            <Field component="textarea" className="form-control" name="description" placeholder="Task Description" />
          </Form.Group>
          ...
          <Form.Group className="text-right">
            <Button variant="primary" className="mr-2" type="submit">{submitText}</Button>
            <Button variant="danger" onClick={onCancel}>{cancelText}</Button>
          </Form.Group>
